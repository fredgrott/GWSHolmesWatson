...
public abstract class PreferenceActivity extends ListActivity implements
    ...
    private static class HeaderAdapter extends ArrayAdapter<Header> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View view;
            if (convertView == null) {
                view = mInflater.inflate(R.layout.he_prefs_preference_header_item,
                        parent, false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.he_prefs_preference_list_content);
        ...
        if (initialFragment != null && mSinglePane) {
            ...
            setContentView(R.layout.he_prefs_preference_list_content_single);
            mListFooter = (FrameLayout) findViewById(R.id.list_footer);
