...
public class UndoBarController extends LinearLayout {
	...
	public static UndoBarStyle UNDOSTYLE = new UndoBarStyle(
			drawable.ub_ic_undobar_undo, string.undo);

	public static UndoBarStyle RETRYSTYLE = new UndoBarStyle(drawable.ub_ic_retry,
			string.retry, -1);
	...
	public UndoBarController(final Context context, final AttributeSet attrs) {
		super(context, attrs);
		LayoutInflater.from(context).inflate(R.layout.ub_undobar, this, true);
