...
public class ChangeLogDialog {
    ...
    public String getHTML() {
        ...
        return getHTMLChangelog(R.xml.inscription_changelog, resources, 0);    	
    }
    ...
    protected void show(final int version) {
        ...
        //Create html change log
        final String htmlChangelog = getHTMLChangelog(R.xml.inscription_changelog, resources, version);
