...
public class HoloListMenuItemView extends LinearLayout implements
    ...
    private void insertCheckBox() {
        ...
        mCheckBox = (CheckBox) inflater.inflate(
                R.layout.he_list_menu_item_checkbox, this, false);
        addView(mCheckBox);
    }

    private void insertIconView() {
        LayoutInflater inflater = getInflater();
        mIconView = (ImageView) inflater.inflate(R.layout.he_list_menu_item_icon,
                this, false);
        addView(mIconView, 0);
    }
    ...
    private void insertRadioButton() {
        ...
        mRadioButton = (RadioButton) inflater.inflate(
                R.layout.he_list_menu_item_radio, this, false);
